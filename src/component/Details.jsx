import {FaAngleDown, FaAngleLeft, FaAngleRight, FaAngleUp, FaCar, FaUser} from "react-icons/fa";
...
import details, {icons} from "../data";
        ...
        <section className={"mt-10 px-3 text-sm md:text-lg md:flex"}>
          ...
          <section className={"opacity-80 rounded-lg bg-[#312C6C] text-white flex flex-col md:w-full"}>
            ...
            <section className={"px-4 mt-4 flex justify-between items-center"}>
              <article>
                <button className={"flex justify-center items-center bg-[#C63333] px-2 gap-x-1 rounded md:p-1.5 shadow-2xl shadow-indigo-500/40"}>
                  <AiFillDelete />
                  Delete
                </button>
              </article>
              ...
              <article className={"flex justify-center items-center gap-x-3"}>
                <p>Records per page</p>
                  <div className={"flex justify-center items-center"}><span className={"border border-r-0 rounded-l px-1"}>10</span> <button className={"bg-gray-500 p-1 md:p-1.5 rounded-r"}><FaAngleDown className={"text-gray-800"} /></button></div>
              </article>

              <article className={"md:w-3/12"}>
                <p className={"p-1.5 bg-[#1E284C] text-start rounded-lg shadow-2xl"}>Search</p>
              </article>
            </section>

            <article className={"mx-4 my-3 rounded border border-gray-600 md:flex md:justify-between"}>
              {details.map((detail) => {
                return (
                  <table className="m-4 border-separate border-spacing-2 border border-slate-500 flex flex-col">
                    <thead className={"flex justify-between items-center p-2 md:gap-x-3"}>
